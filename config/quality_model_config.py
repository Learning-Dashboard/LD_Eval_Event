...
def load_qualitymodel_map(
    path: str = "config_files/quality_models_teams_config.json",
) -> dict:
    """
...
def choose_qualitymodel(
    external_id: str, explicit_qm: Optional[str], qm_map: dict
) -> str:
    """
