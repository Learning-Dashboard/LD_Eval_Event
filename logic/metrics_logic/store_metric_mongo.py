...
def store_metric_result(
    team_name: str,
    metric_def: str,
    final_val: float,
    event_type: str,
    student_name: str = None,
    aggregator_doc: dict = None,
    info_collection_name: str = None,
):
    """
    ...
    if student_name:
        ...
        if (
            student_name
        ):  # If the metric is for a student, add the student name to the document
    ...
    collection.update_one(
        {"_id": doc_id}, {"$set": dynamic, "$setOnInsert": static}, upsert=True
    )
